 ...
 * 
 * 3. 基于注解的方式来使用 AOP
 * 3.1 在配置文件中配置自动扫描的包: <context:component-scan base-package="com.zz.spring.aop.impl"></context:component-scan>
 * 		
 ...
 * 5.3.1 前置通知: @Before("execution(public int com.zz.spring.aop.impl.ArithmeticCalculator.*(int, int))")
...
//把这个类声明为一个切面：首先需要把该类放入IOC容器中，再声明为一个切面
